...
<body class="bg-gray-100 font-sans">
            ...
            <div class="bg-white shadow-sm border-b border-gray-200">
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex items-center">
                            <h1 class="text-2xl font-semibold text-gray-900">Nouveau Prêt</h1>
                        </div>
                        <div class="flex items-center space-x-4">
                            ...
                            <a href="${pageContext.request.contextPath}/pret/simulation" 
                               class="inline-flex items-center px-4 py-2 border border-blue-300 text-sm font-medium rounded-lg text-blue-700 bg-blue-50 hover:bg-blue-100 shadow-sm transition-all duration-200">
    ...
    <script>
        ...
        // Auto-focus sur le premier champ - supprimé car déjà géré
